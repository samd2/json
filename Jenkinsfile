    ...
    stages {
        ...
        stage('Build develop or master branch') {
            ...
            steps {
                ...
                s3Upload( entries [[ sourceFile: "boost-root/libs/json/doc/html/**",  bucket: "cppalliance-websites/${BRANCH_NAME}.${DNSREPONAME}.cpp.al", selectedRegion: 'us-east-1' ]], profileName: "cppalliance-bot-profile")
            }
        }
    }
}
