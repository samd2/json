    ...
    stages {
        ...
        stage('Build develop or master branch') {
            ...
            steps {
                ...
                s3Upload entries: [[ sourceFile: "boost-root/libs/${REPONAME}/doc/html/**",  bucket: "cppalliance-websites/${BRANCH_NAME}.${DNSREPONAME}.cpp.al", selectedRegion: 'us-east-1' ]], profileName: "cppalliance-bot-profile", userMetadata: [], dontWaitForConcurrentBuildCompletion: false, consoleLogLevel: 'INFO', pluginFailureResultConstraint: 'FAILURE'
            }
        }
    }
}
