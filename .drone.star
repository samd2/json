...
def main(ctx):
  ...
  linux_cxx("gcc 11", "g++-11", packages="g++-9", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2004:1", environment={'B2_TOOLSET': 'gcc-11', 'B2_CXXSTD': '17,2a', 'DRONE_JOB_UUID': '17ba079169'}, globalenv=globalenv),
  ...
  linux_cxx("clang 8 broken?", "clang++-8", packages="libc6-dbg libc++-dev libstdc++-8-dev", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'B2_TOOLSET': 'clang-8', 'B2_CXXSTD': '17,2a', 'DRONE_JOB_UUID': '0716d9708d'}, globalenv=globalenv),
  ...
  linux_cxx("clang 9 broken?", "clang++-9", packages="libc6-dbg libc++-dev libstdc++-9-dev", buildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'B2_TOOLSET': 'clang-9', 'B2_CXXSTD': '03,11,14,17,2a', 'DRONE_JOB_UUID': '9e6a55b6b4'}, globalenv=globalenv),
