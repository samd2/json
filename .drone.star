...
def main(ctx):
  ...
  linux_cxx("clang 8 broken?", "clang++-8", packages="libc6-dbg libc++-dev libstdc++-8-dev", uildtype="boost", buildscript="drone", image=linuxglobalimage, environment={'B2_TOOLSET': 'clang-8', 'B2_CXXSTD': '17,2a', 'DRONE_JOB_UUID': '0716d9708d'}, globalenv=globalenv),
