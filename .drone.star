...
def main(ctx):
  return [
  linux_cxx("Clang 14 s390x", "clang++-14", packages="clang-14 libstdc++-10-dev", llvm_os="jammy", llvm_ver="14", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2204:multiarch", environment={'B2_TOOLSET': 'clang-14', 'B2_CXXSTD': '17,20'}, arch="s390x", globalenv=globalenv),
  ...
  linux_cxx("Clang 14 arm64", "clang++-14", packages="clang-14 libstdc++-9-dev", llvm_os="jammy", llvm_ver="14", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2204:multiarch", environment={'B2_TOOLSET': 'clang-14', 'B2_CXXSTD': '17,20'}, arch="arm64", globalenv=globalenv),
