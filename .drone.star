...
def main(ctx):
  ...
  windows_cxx("msvc-14.3-test", "", image="cppalliance/test", buildtype="boost", buildscript="drone", environment={"B2_TOOLSET": "msvc-14.3", "B2_CXXSTD": "17,20"}, globalenv=globalenv),
