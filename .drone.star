...
def main(ctx):
  ...
  linux_cxx("gcc 11", "g++-11", packages="g++-11", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2204:test2", environment={'B2_TOOLSET': 'gcc-11', 'B2_CXXSTD': '17,2a', 'DRONE_JOB_UUID': '0716d9708d'}, globalenv=globalenv),
  ...
  linux_cxx("U22 Clang 14", "clang++-14", packages="clang-14 libstdc++-10-dev", llvm_os="jammy", llvm_ver="14", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2204:test2", environment={'B2_TOOLSET': 'clang-14', 'B2_CXXSTD': '17,20', 'DRONE_JOB_UUID': '7719a1c783'}, globalenv=globalenv),
  linux_cxx("U22 Clang 14 included", "clang++-14", packages="libstdc++-10-dev", buildtype="boost", buildscript="drone", image="cppalliance/droneubuntu2204:test2", environment={'B2_TOOLSET': 'clang-14', 'B2_CXXSTD': '17,20', 'DRONE_JOB_UUID': '7719a1c783'}, globalenv=globalenv),
